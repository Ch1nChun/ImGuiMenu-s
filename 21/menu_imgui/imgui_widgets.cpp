...
bool ImGui::tab(const char* label, bool selected) {
    ...
    if (selected) {
        target_color = ImColor(210, 100, 185, 255); // Pink color for selected tabs
    }
    ...
    if (selected || current_alpha > 0) {
        ...
        if (selected || current_alpha > 0) {
            ...
            ImColor top_line_color = ImColor(210, 100, 185, current_alpha); // Pink top line color with fade
...
bool ImGui::subtab(const char* label, bool selected) { // subtab color
    ...
    ImColor line_color = ImColor(210, 100, 185, static_cast<int>(current_line_alpha));  // Pink color with animated alpha
...
bool ImGui::Checkbox(const char* label, bool* v)
{
    ...
    if (check_t > 0.0f)
    {
        window->DrawList->AddRectFilled(ImVec2(check_bb.Min.x + pad + 2.5, check_bb.Min.y + pad + 2.5), ImVec2(check_bb.Max.x - pad - 2.5, check_bb.Max.y - pad - 2.5), ImColor(210, 100, 185, int(check_t * 255)), 0);
    }
...
bool ImGui::SliderScalar(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format, ImGuiSliderFlags flags)
{
    ...
    if (grab_bb.Max.x > grab_bb.Min.x) {
        window->DrawList->AddRectFilled(ImVec2(frame_bb.Min.x, frame_bb.Min.y + 8), ImVec2(grab_bb.Max.x, grab_bb.Max.y - 5 - 7), ImColor(210, 100, 185, 255), style.GrabRounding);
    }
