...
namespace ImGui
{
    ...
    IMGUI_API void          RenderFrame(ImVec2 p_min, ImVec2 p_max, ImU32 fill_col, bool border = true, float rounding = 0.0f, bool border2 = false);
    IMGUI_API void          RenderFrame2(ImVec2 p_min, ImVec2 p_max, bool border = true, float rounding = 0.0f, bool border2 = false);
