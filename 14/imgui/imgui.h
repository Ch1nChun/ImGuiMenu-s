...
enum ImGuiWindowFlags_
{
    ...
    ImGuiWindowFlags_FalconTriangle         = 1 << 29
...
struct ImDrawList
{
    ...
    IMGUI_API void  AddText(const ImVec2& pos, ImU32 col, const char* text_begin, const char* text_end = NULL, bool outline = false, float font_size = 0.0f);
