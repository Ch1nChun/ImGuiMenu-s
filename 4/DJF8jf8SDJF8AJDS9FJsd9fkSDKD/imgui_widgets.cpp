...
bool ImGui::tab(const char* label, bool selected)
{
    ...
    draw->AddRectFilled(bb.Min, bb.Max, ImColor(242, 242, 247), 4);
    draw->AddRect(bb.Min, bb.Max, ImColor(193, 193, 197), 4);
    if (selected)
        draw->AddLine(ImVec2(bb.Max.x + 7, bb.Min.y + 3), ImVec2(bb.Max.x + 7, bb.Max.y - 3), ImColor(50, 50, 55), 2);
...
bool ImGui::ButtonEx(const char* label, const ImVec2& size_arg, ImGuiButtonFlags flags)
{
    ...
    draw->AddRect(bb.Min, bb.Max, ImColor(202, 202, 207), 4);
    draw->AddRectFilled(bb.Min, ImVec2(bb.Max.x + 1, bb.Max.y + 1), GetColorU32(ImVec4(242 / 255.f, 242 / 255.f, 247 / 255.f, it_filled->second)), 4);
...
bool ImGui::BeginCombo(const char* label, const char* preview_value, ImGuiComboFlags flags)
{
    ...
    window->DrawList->AddRect(frame_bb.Min, ImVec2(frame_bb.Max.x, frame_bb.Max.y), ImColor(202, 202, 207), style.ComboRounding, popup_open ? 3 : 15);
    ...
    else
    {
        ...
        SetNextWindowSizeConstraints(ImVec2(220, 0.0f), ImVec2(FLT_MAX, CalcMaxPopupHeightFromItemCount(popup_max_height_in_items)));
    }
...
bool ImGui::settingsbutton(const char* label)
{
    ImGuiWindow* window = ImGui::GetCurrentWindow();
    if (window->SkipItems)
        return false;
