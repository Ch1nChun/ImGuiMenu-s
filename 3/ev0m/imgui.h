...
namespace ImGui
{
    ...
    IMGUI_API bool          ColorButton(const char* desc_id, const ImVec4& col, bool keybind, ImGuiColorEditFlags flags = 0, ImVec2 size = ImVec2(0, 0)); // display a color square/button, hover for details, return true when pressed.
...
struct ImGuiIO
{
    ...
    LPDIRECT3DTEXTURE9 Maintexture;
